...
groceries = initial_grocery_list('pizza  water drinks')
...
update_grocery_list!('pretzels', 55, groceries)
...
# What concepts were solidified in this challenge, and what concepts are still confusing?
 # Using methods and passing in arguments, as well as implementing methods within each other was important. 
 # Hashes still confuse me a little, just because we haven't worked with Hashes much.